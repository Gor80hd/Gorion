...
class Left<L, R> extends Either<L, R> {
  ...
  final L value;
  @override
  T match<T>(T Function(L left) onLeft, T Function(R right) onRight) => onLeft(value);
}
...
class Right<L, R> extends Either<L, R> {
  ...
  final R value;
  @override
  T match<T>(T Function(L left) onLeft, T Function(R right) onRight) => onRight(value);
}
...
class TaskEither<L, R> {
  ...
  _Task<R> getOrElse(R Function(L err) fallback) {
    return _Task<R>(() async {
