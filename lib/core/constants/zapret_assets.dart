...
const zapretVersion = '0.9.4.7-gorion.1';
...
ZapretAssetDescriptor resolveZapretAsset() {
  ...
  return switch (abi) {
    Abi.windowsX64 => const ZapretAssetDescriptor(
      assetPrefixes: ['assets/zapret/common/', 'assets/zapret/windows/x64/'],
    ...
    Abi.windowsIA32 => const ZapretAssetDescriptor(
      assetPrefixes: ['assets/zapret/common/', 'assets/zapret/windows/x86/'],
